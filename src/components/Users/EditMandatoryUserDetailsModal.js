    ...
    <Fragment>
        ...
        <form onSubmit={editUserDetails}>
            ...
            <select id='gender' ref={genderRef}>
                <option value={Constants.MALE} selected={userDetails.gender == Constants.MALE}>Male</option>
                <option value={Constants.FEMALE} selected={userDetails.gender == Constants.FEMALE} >Female</option>
                <option value={Constants.NMNF} selected={userDetails.gender == Constants.NMNF}>Other</option>
            </select>
            </div>
